<template>
    <div id="laser">
        <b-container>
            ...
            <img src="../../../public/images/activity/5.jpg" class="descr_img" alt="Лазерная_гравировка">
            <p class="text">
            ...
            <p class="text">
                Гравировка по дереву и пластику происходит <u> с помощью лазерного гравера </u>. Если материал однородный, то цвет гравировки лишь слегка темнее цвета наружного слоя. Такой <u> метод </u>является <u>бесконтактным</u>, благодаря чему удается достичь высокой скорости работы и безупречного качества нанесенных изображений.
            </p>
            <p class="text clear">
                Лазерная гравировка создает абсолютно эксклюзивные аксессуары для офиса и дома с неповторимым уникальным рисунком, скопировать которые практически невозможно. Внешняя эстетика и очарование таких изделий не может оставить равнодушным никого!
            </p>
            <p class="text">
                Наши специалисты готовы реализовать Ваш проект точно в соответствии с техническим заданием, быстро и качественно. При необходимости мы разрабатываем под Ваши потребности дизайн-проект и согласовываем его с Вами до момента нанесения его на материал.
            </p>
