<template>
    <div id="processing">
        <b-container>
            ...
            <img src="../../../public/images/activity/1.jpg" class="descr_img" alt="Обработка_дерева,_металла_и_пластика_на_фрезерном_станке_ЧПУ">
            <p class="text">
            ...
            <p class="text">
                Фрезерный обрабатывающий центр ЧПУ позволяет изготавливать изделия любой сложности высокого качества. С помощью этого станка наши сотрудники изготавливают 3D детали машин, фигурные шайбы, корпуса, элементы декора, фигурные объемные буквы, алюминиевые таблички, вывески, декоративные изделия из дерева и многое другое.
            </p>
            <p class="text clear">
                Работа на фрезерно-гравировальном станке с ЧПУ основывается на микропроцессорах и операционных системах, а собственные микроконтроллеры системы ЧПУ управляют приводами. Благодаря полной автоматизации процесса, мы добиваемся самой точной обработки разнообразных материалов: снижаем до минимума вероятность брака, что увеличивает производительность работы.
            </p>
